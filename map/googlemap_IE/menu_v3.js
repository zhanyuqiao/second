...
function saveMapFile() {
	...
	if(operating_value == "Station search") {
		file_name =search_lat + ";" + search_lng + ";" + search_flag + ";" + operating_value + ";" + "Radius_" + radius_value + ";" +"request-time_" + request_time_value + ";" + "draw-time_" + draw_time_value + ".json";
	} else if(operating_value == "displayisoline") {
		file_name = operating_value + ";" + "Mode_" + Mode_value + ";" + "Types_" + routingtypes_value + ";" + "traffic_" + traffic_value + ";" + "RangeType_" + rangetype_value + ";" + "Range_" + range_value + ";" + "MaxPoints_" + maxpoints_value + ";" + "Resolution_" + resolution_value + ";" + "ascent_" + ascent_value + ";" + "descent_" + descent_value + ";" + "request-time_" + request_time_value + ";" + "draw-time_ " + draw_time_value + ".json";
	} else if(operating_value == "CalculatingRoute") {
		file_name = operating_value + ";" + "Mode_" + Mode_value + ";" + "Types_" + routingtypes_value + ";" + "traffic_" + traffic_value + ";" +  "RangeType_" + rangetype_value + ";" + "request-time_" + request_time_value + ";" + "draw-time_ " + draw_time_value +".json";
	} else if(operating_value == "ChargingPileRoad") {
		file_name = operating_value + ";" + "CorridorWidth_" + corridorWidth_value + ";" + "request_time" + request_time_value + ";" + "draw_time " + draw_time_value + ".json";
	}
	file_path = "E:" +  file_name + ".txt";
	var log_text = $("#log").val();
	fso=new ActiveXObject("Scripting.FileSystemObject"); 
	var f1 = fso.CreateTextFile(file_path,true);
	f1.write(log_text);
	f1.close();
}
